...
- [ ] 19. **特定商取引法ページの事業者情報入力** — `src/app/law/page.tsx` の代表者名・所在地・電話番号がダミー（`○○ ○○`等）。5箇所のTODOコメントを実データに差し替え
- [ ] 20. **プライバシーポリシーの連絡先確認** — `src/app/privacy/page.tsx` にTODOコメント1箇所。メールアドレスの確認・差し替え
